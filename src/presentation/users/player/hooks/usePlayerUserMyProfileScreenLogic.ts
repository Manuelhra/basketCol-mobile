...
import { PlayerUserBottomNavigatorParamList } from '../navigation/PlayerUserBottomNavigator';
...
export const usePlayerUserMyProfileScreenLogic = () => {
  ...
  const {
    ...
    teamActivePlayer,
  } = useFindTeamActivePlayer(findTeamActivePlayerUseCase, authenticatedUser?.id ?? '');
